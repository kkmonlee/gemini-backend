...
func TestLogin(t *testing.T) {
	...
	samples := []struct {
		...
		{
			inputJSON:    `{"email": "memerson0@netscape.com", "password": "password"}`,
			statusCode:   200,
			errorMessage: "",
		},
		{
			inputJSON:    `{"email": "memerson0@netscape.com", "password": "wrong password"}`,
			statusCode:   422,
			errorMessage: "Incorrect Password",
		},
		{
			inputJSON:    `{"email": "alanmeid3@blinklist.com", "password": "password"}`,
			statusCode:   422,
			errorMessage: "Incorrect Details",
		},
		{
			inputJSON:    `{"email": "google.com", "password": "password"}`,
			statusCode:   422,
		...
		{
			inputJSON:    `{"email": "dcamidge4@typepad.com", "password": ""}`,
			statusCode:   422,
