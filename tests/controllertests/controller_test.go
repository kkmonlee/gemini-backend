...
func seedOneUser() (models.User, error) {
	...
	user := models.User{
		Username: "Mellie Emerson",
		Email:    "memerson0@netscape.com",
		Password: "password",
	}
...
func seedUsers() ([]models.User, error) {
	...
	users := []models.User{
		models.User{
			Username: "Fifi McKinlay",
			Email:    "fmckinlay1@altervista.org",
			Password: "password",
		},
		models.User{
			Username: "Bel O'Currigan",
			Email:    "bocurrigan2@newyorker.com",
			Password: "password",
		},
	}
	for i := range users {
...
func seedOneUserAndOnePost() (models.Post, error) {
	...
	user := models.User{
		Username: "Alvis Lanmeid",
		Email:    "alanmeid3@blinklist.com",
		Password: "password",
	}
	err = server.DB.Model(&models.User{}).Create(&user).Error
	if err != nil {
	...
	post := models.Post{
		Title:    "Alvis' title",
		Content:  "In congue. Etiam justo. Etiam pretium iaculis",
		AuthorID: user.ID,
	}
...
func seedUsersAndPosts() ([]models.User, []models.Post, error) {
	...
	var posts = []models.Post{
		...
		models.Post{
			Title:   "Tintin and I",
			Content: "Aenean fermentum. Donec ut mauris eget massa tempor convallis. Nulla neque libero",
		},
	}
